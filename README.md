...
- **자리 연습**: 기본 자리부터 특수문자까지 체계적인 연습
- **낱말 연습**: 자주 쓰이는 단어 위주의 순발력 연습
- **문장 연습**: 긴 문장을 통한 실전 타자 속도 측정
- **실시간 통계**: 정확도(ACC), 속도(WPM) 등을 실시간으로 확인

### 🎈 풍선 타자 게임 (Balloon Typing Game)
- **실시간 멀티플레이어**: Socket.io를 활용한 최대 8인 동시 대결
- **다양한 난이도**: 단어 길이에 따른 점수 차등 부여
- **글로벌 채팅 & 로비**: 방 만들기, 빠른 입장 등 편리한 게임 참여 환경
...
---
Created by [leesk1283](https://github.com/leesk1283)
